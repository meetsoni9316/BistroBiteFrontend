    ...
    <div className="fixed right-2 bottom-0 ">
      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical ">
        <li>
          ...
          <div className="timeline-end  md:mb-10 mb-0">
            <time className=" text-sb">123 Culinary Avenue,</time>
            <div className="text-sb">Foodie City, FC 56789</div>
          </div>
          <hr />
        </li>
        <li>
          ...
          <div className="timeline-end md:mb-10 mb-3">
            <time className=" text-sb">contact@bistrobite.com</time>
          </div>
          <hr />
        </li>
        <li>
          ...
          <div className="timeline-middle ">
            <svg
              ...
              height="20"
              fill="currentColor"
              class="bi bi-telephone text-black"
              viewBox="0 0 16 16"
            >
          ...
          <div className="timeline-end md:text-end md:mb-10 mb-3">
            <time className="text-sb">(123) 456-7890</time>
          </div>
          <hr />
        </li>
        <li>
          ...
          <div className="timeline-end md:mb-10 mb-2  ">
            <a className="text-sb">Chat with us on WhatsApp</a>
          </div>
          <hr />
        </li>
      </ul>
